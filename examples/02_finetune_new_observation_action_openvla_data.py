...
python octo/examples/02_finetune_new_observation_action_openvla_data.py --pretrained_path=hf://rail-berkeley/octo-small-1.5 --data_dir=modified_libero_rlds/libero_object_no_noops --save_dir=modified_libero_rlds/libero_object_no_noops/finetuned_chkpt
python examples/02_finetune_new_observation_action_openvla_data.py --pretrained_path=hf://rail-berkeley/octo-small-1.5 --data_dir=../modified_libero_rlds/libero_object_no_noops --save_dir=../modified_libero_rlds/libero_object_no_noops/finetuned_chkpt
PYTHONPATH=examples/libero/libero_object python examples/02_finetune_new_observation_action_openvla_data.py --pretrained_path=hf://rail-berkeley/octo-small-1.5 --data_dir=examples/libero/libero_object/libero_object_no_noops/1.0.0 --save_dir=examples/libero/libero_object/libero_object_no_noops/finetuned_chkpt

python examples/02_finetune_new_observation_action_openvla_data.py --pretrained_path=hf://rail-berkeley/octo-small-1.5 --data_dir=examples/libero/libero_object --save_dir=examples/libero/libero_object/libero_object_no_noops/finetuned_chkpt
"""
# import libero.libero_object.libero_object_no_noops


# import tensorflow_datasets as tfds
# from libero.libero_object.libero_object_no_noops.libero_object_no_noops import Builder

# tfds.core.registered.register_builder("libero_object", Builder)



import libero.libero_object.libero_object_no_noops.libero_object_no_noops
...
flags.DEFINE_integer("batch_size", 16, "Batch size for finetuning.") #was 128 initially
...
def main(_):
    ...
    wandb.init(name="finetune_libero", project="octo")
    ...
    dataset = make_single_dataset(
        dataset_kwargs=dict(
            ...
            image_obs_keys = {
                "rgb": "image",  # ✅ maps to the correct key in your dataset
                "wrist": "wrist_image"
            },
    ...
    for i in tqdm.tqdm(range(5000), total=5000, dynamic_ncols=True):
        ...
        if (i + 1) % 1000 == 0:
            ...
            logging.info(f"Saving checkpoint to {FLAGS.save_dir}")
            train_state.model.save_pretrained(step=i, checkpoint_path=os.path.abspath(FLAGS.save_dir))
