...
python examples/02_finetune_new_observation_action.py --pretrained_path=hf://rail-berkeley/octo-small-1.5 --data_dir=examples/example_sim_data/aloha_sim_dataset --save_dir=examples/example_sim_data/finetuned_chkpt
"""
